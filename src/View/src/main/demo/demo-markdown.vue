...
<template>
  <div>
    ...
    <fieldset>
      ...
      <aside>
        <components_markdown ref='editor' v-model='content' @html='onHtml' :config='config' @init='initDone'></components_markdown>
        <br>
    ...
    <div class="panel">
      更多自定义配置请参考 <a href='https://hacpai.com/article/1549638745630?r=Vanessa' target='_blank'>Vditor 文档</a>。
    </div>
  </div>
</template>
<script>
