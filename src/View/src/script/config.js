...
var apis = {
  ...
  sysMenu: ["get", "/ZlsManage/SystemApi/Menu.go"],
  ...
  sysUpdateUserRuleStatus: [
    "put",
    "/ZlsManage/UserManageApi/UpdateUserRuleStatus.go"
  ],
  ...
  sites: ["get", "/SiteApi/lists.go"],
  getSite: ["get", "/SiteApi/site.go"],
  createSites: ["post", "/SiteApi/site.go"],
  deleteSites: ["delete", "/SiteApi/site.go"],
  updateSites: ["put", "/SiteApi/site.go"],
  deleteSitesFile: ["delete", "/SiteFileApi/Upload.go"],
  editSitesFileContent: ["put", "/SiteFileApi/file.go"],
  getSitesFileContent: ["get", "/SiteFileApi/file.go"],
  uploadSites: "/SiteFileApi/Upload.go",
  deleteSitesImageFile: ["delete", "/SiteFileApi/UploadImage.go"],
  uploadImageSites: "/SiteFileApi/UploadImage.go"
};
